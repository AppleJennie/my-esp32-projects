...
lv_obj_t * ui_MenuDataPanel;
lv_obj_t * ui_MenuDataButton;
lv_obj_t * ui_MenuDataicon;
lv_obj_t * ui_MenuDataLabel;
...
void ui_event_MenuDataPanel(lv_event_t * e)
{
	lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED)
...
void ui_MenuPage_screen_init(void)
{
    ...
    lv_obj_set_y(ui_MenuSprPanel, 140);
    ...
    lv_obj_set_y(ui_MenuHRPanel, 210);
    ...
    lv_obj_set_y(ui_MenuEnvPanel, 280);
    ...
    lv_obj_set_y(ui_MenuCPPanel, 350);
    ...
    lv_obj_set_y(ui_MenuSetPanel, 420);
    ...
    lv_obj_set_y(ui_MenuAbPanel, 490);
...
#if DATA_PAGE_EN
    ui_MenuDataPanel = lv_obj_create(ui_MenuPage);
    lv_obj_set_width(ui_MenuDataPanel, 240);
    lv_obj_set_height(ui_MenuDataPanel, 70);
    lv_obj_set_x(ui_MenuDataPanel, 0);
    lv_obj_set_y(ui_MenuDataPanel, 560);
    lv_obj_set_align(ui_MenuDataPanel, LV_ALIGN_TOP_MID);
    lv_obj_clear_flag(ui_MenuDataPanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_MenuDataPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuDataPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MenuDataPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui_MenuDataPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_MenuDataPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuDataPanel, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_MenuDataPanel, 100, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_MenuDataButton = lv_btn_create(ui_MenuDataPanel);
    lv_obj_set_width(ui_MenuDataButton, 40);
    lv_obj_set_height(ui_MenuDataButton, 40);
    lv_obj_set_align(ui_MenuDataButton, LV_ALIGN_LEFT_MID);
    lv_obj_add_flag(ui_MenuDataButton, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_MenuDataButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_MenuDataButton, 40, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_MenuDataButton, lv_color_hex(0x3278FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MenuDataButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MenuDataicon = lv_label_create(ui_MenuDataButton);
    lv_obj_set_width(ui_MenuDataicon, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_MenuDataicon, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_MenuDataicon, LV_ALIGN_CENTER);
    lv_label_set_text(ui_MenuDataicon, "D");
    lv_obj_set_style_text_font(ui_MenuDataicon, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MenuDataLabel = lv_label_create(ui_MenuDataPanel);
    lv_obj_set_width(ui_MenuDataLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_MenuDataLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_MenuDataLabel, 60);
    lv_obj_set_y(ui_MenuDataLabel, 0);
    lv_obj_set_align(ui_MenuDataLabel, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_MenuDataLabel, "DATA");
    lv_obj_set_style_text_font(ui_MenuDataLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
#endif
...
#if DATA_PAGE_EN
	lv_obj_add_event_cb(ui_MenuDataPanel, ui_event_MenuDataPanel, LV_EVENT_ALL, NULL);
#endif
