...
//sport settings entry
static lv_obj_t * ui_SportSetPanel;
static lv_obj_t * ui_SportSetButton;
static lv_obj_t * ui_SportSeticon;
static lv_obj_t * ui_SportSetLabel;
...
void ui_event_SportSetPanel(lv_event_t * e)
{
	lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED)
    {
        Page_Load(&Page_SportSet);
    }
}
...
void ui_SetPage_screen_init(void)
{
    ...
    ui_SportSetPanel = lv_obj_create(ui_SetPage);
    lv_obj_set_width(ui_SportSetPanel, 240);
    lv_obj_set_height(ui_SportSetPanel, 70);
    lv_obj_set_x(ui_SportSetPanel, 0);
    lv_obj_set_y(ui_SportSetPanel, 350);
    lv_obj_set_align(ui_SportSetPanel, LV_ALIGN_TOP_MID);
    lv_obj_clear_flag(ui_SportSetPanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_SportSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_SportSetPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_SportSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_SportSetPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_SportSetPanel, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_SportSetPanel, 100, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_SportSetButton = lv_btn_create(ui_SportSetPanel);
    lv_obj_set_width(ui_SportSetButton, 40);
    lv_obj_set_height(ui_SportSetButton, 40);
    lv_obj_set_align(ui_SportSetButton, LV_ALIGN_LEFT_MID);
    lv_obj_add_flag(ui_SportSetButton, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_SportSetButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_SportSetButton, 40, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_SportSetButton, lv_color_hex(0x009680), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_SportSetButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_SportSeticon = lv_label_create(ui_SportSetButton);
    lv_obj_set_width(ui_SportSeticon, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_SportSeticon, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_SportSeticon, LV_ALIGN_CENTER);
    lv_label_set_text(ui_SportSeticon, "S");
    lv_obj_set_style_text_font(ui_SportSeticon, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_SportSetLabel = lv_label_create(ui_SportSetPanel);
    lv_obj_set_width(ui_SportSetLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_SportSetLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_SportSetLabel, 60);
    lv_obj_set_y(ui_SportSetLabel, 0);
    lv_obj_set_align(ui_SportSetLabel, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_SportSetLabel, "SPORT");
    lv_obj_set_style_text_font(ui_SportSetLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_event_cb(ui_SportSetPanel, ui_event_SportSetPanel, LV_EVENT_ALL, NULL);
