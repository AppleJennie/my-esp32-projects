 ...
 * 波形缓冲区大小
 * ================================================================ */
#define BREATH_WAVE_BUF_SIZE    60   /* 保存最近 60 个呼吸波形采样 */
#define HEART_WAVE_BUF_SIZE     60   /* 保存最近 60 个心率波形采样 */
...
typedef struct {
    ...
    uint8_t  heart_wave_idx;
    uint8_t  heart_wave_count;
    ...
    uint8_t  breath_wave_idx;
    uint8_t  breath_wave_count;
