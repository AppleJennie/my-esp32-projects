...
/* SpO2 Reference Estimation (NOTE: EM7028 has only green LED, no Red/IR.
 * This is NOT medical-grade SpO2. It provides a rough estimate based on
 * heart rate and PPG perfusion index for reference only. */
