...
void HW_Motor_ShortVib(void)
{
    Motor_Vibrate(MOTOR_SHORT);
}

void HW_Motor_LongVib(void)
{
    Motor_Vibrate(MOTOR_LONG);
}

void HW_Motor_DoubleVib(void)
{
    Motor_Vibrate(MOTOR_DOUBLE);
}

void HW_Motor_Start(void)
{
    Motor_ContinuousStart();
}

void HW_Motor_Stop(void)
{
    Motor_ContinuousStop();
}
...
HW_InterfaceTypeDef HWInterface = {
	...
	.Motor = {
		.Init      = HW_Motor_Init,
		.ShortVib  = HW_Motor_ShortVib,
		.LongVib   = HW_Motor_LongVib,
		.DoubleVib = HW_Motor_DoubleVib,
		.Start     = HW_Motor_Start,
		.Stop      = HW_Motor_Stop
	}
};
