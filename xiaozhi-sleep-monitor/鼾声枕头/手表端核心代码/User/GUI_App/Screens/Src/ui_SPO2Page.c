...
lv_obj_t * ui_SPO2MotorBtn;
lv_obj_t * ui_SPO2MotorLabel;

lv_timer_t * ui_SPO2PageTimer;

/////////////////// Motor button event ///////////////////
static void ui_event_SPO2MotorBtn(lv_event_t * e)
{
...
void ui_SPO2Page_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_SPO2Page, LV_OBJ_FLAG_SCROLLABLE);

    ui_SPO2NumLabel = lv_label_create(ui_SPO2Page);
    lv_obj_set_width(ui_SPO2NumLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_SPO2NumLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_SPO2UnitLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_SPO2UnitLabel, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_SPO2NoticeLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_SPO2NoticeLabel, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_SPO2NoticeLabel, 0);
    lv_obj_set_y(ui_SPO2NoticeLabel, 90);
    lv_obj_set_align(ui_SPO2NoticeLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_SPO2NoticeLabel, "参考值(非医用)");
    ...
    lv_obj_set_width(ui_SPO2Icon, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_SPO2Icon, LV_SIZE_CONTENT);
    ...
    /* ─────── 震动测试按钮 ─────── */
    ui_SPO2MotorBtn = lv_btn_create(ui_SPO2Page);
    lv_obj_set_size(ui_SPO2MotorBtn, 100, 40);
    lv_obj_set_align(ui_SPO2MotorBtn, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(ui_SPO2MotorBtn, -20);
    lv_obj_set_style_bg_color(ui_SPO2MotorBtn, lv_color_hex(0x7D197D), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui_SPO2MotorBtn, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_event_cb(ui_SPO2MotorBtn, ui_event_SPO2MotorBtn, LV_EVENT_CLICKED, NULL);

    ui_SPO2MotorLabel = lv_label_create(ui_SPO2MotorBtn);
    lv_obj_set_align(ui_SPO2MotorLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_SPO2MotorLabel, "震动测试");
    lv_obj_set_style_text_font(ui_SPO2MotorLabel, &ui_font_Cuyuan20, LV_PART_MAIN | LV_STATE_DEFAULT);
